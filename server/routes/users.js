...
router.post(
	...
	[
		isAdmin,
		body("name").isLength({ min: 10, max: 60 }).withMessage("Name must be between 20 and 60 characters"),
...
router.put(
	...
	[
		isAdminOrSelf,
		body("name").optional().isLength({ min: 10, max: 60 }).withMessage("Name must be between 20 and 60 characters"),
